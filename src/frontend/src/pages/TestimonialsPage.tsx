...
export default function TestimonialsPage() {
  ...
  const stats = [
    { icon: Users, label: 'Community Members', value: '12,847+', color: 'text-gold' },
    { icon: TrendingUp, label: 'Token Holders', value: '8,934+', color: 'text-green-400' },
    { icon: Shield, label: 'Security Score', value: '99.9%', color: 'text-blue-400' },
    { icon: Zap, label: 'Satisfaction Rate', value: '98.5%', color: 'text-purple-400' },
  ];
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-20 animate-fade-in-up">
            ...
            <h1 className="text-5xl md:text-7xl font-orbitron font-bold mb-8 leading-tight">
              <span className="shimmer-gold">Community Testimonials</span>
            </h1>
            <p className="text-xl md:text-2xl text-silver/80 font-inter max-w-3xl mx-auto leading-relaxed">
              Hear from our community members about their RBS experience and vision for the future
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-20 animate-fade-in-up animation-delay-200">
            {stats.map((stat, index) => (
              <div
                key={index}
                className="bg-black/60 backdrop-blur-sm border-2 border-gold/30 rounded-xl p-8 text-center glow-border transition-all duration-700 hover:scale-105"
              >
                ...
                <p className={`text-4xl font-jetbrains font-bold ${stat.color} mb-2`}>{stat.value}</p>
                ...
                {testimonials.map((testimonial, index) => (
                  <CarouselItem key={index} className="md:basis-1/2 lg:basis-1/3">
                    <div className="p-4 h-full">
                      <div className="bg-black/60 backdrop-blur-sm border-2 border-gold/30 rounded-xl p-8 h-full flex flex-col glow-border transition-all duration-700 hover:scale-105 hover:shadow-2xl hover:shadow-gold/20">
                        <div className="flex items-center gap-4 mb-6">
                          <div className="h-16 w-16 rounded-full bg-gradient-to-br from-gold/40 to-gold/15 border-2 border-gold/60 flex items-center justify-center flex-shrink-0">
                            <span className="text-gold font-orbitron font-bold text-lg">{testimonial.avatar}</span>
                          </div>
                          <div className="flex-1 min-w-0">
                            <h3 className="text-lg font-orbitron font-bold text-gold truncate">{testimonial.name}</h3>
                            <p className="text-sm text-silver/70 font-inter truncate">{testimonial.role}</p>
                          </div>
                        </div>
                        ...
                        <p className="text-silver/80 font-inter leading-relaxed mb-6 flex-1">
                          "{testimonial.text}"
                        </p>
          ...
          <div className="bg-gradient-to-br from-gold/10 to-black/60 backdrop-blur-sm border-2 border-gold/40 rounded-xl p-12 text-center glow-border animate-fade-in-up animation-delay-400">
            <h2 className="text-4xl font-orbitron font-bold text-gold mb-6">Join Our Growing Community</h2>
            <p className="text-xl text-silver/80 font-inter mb-8 max-w-2xl mx-auto leading-relaxed">
              Be part of the RBS revolution. Connect with thousands of community members, participate in governance, and shape the future of professional crypto tokens.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                ...
                className="px-8 py-4 bg-gold hover:bg-gold/90 text-black font-orbitron font-bold rounded-lg transition-all duration-700 metallic-button hover:scale-105"
              >
                Join Telegram
              </a>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="px-8 py-4 bg-black border-2 border-gold/30 hover:border-gold text-gold font-orbitron font-bold rounded-lg transition-all duration-700 hover:scale-105"
              >
                Join WhatsApp
              </a>
            </div>
