            ...
            <>
              ...
              <div className="glass-card p-8 mb-6 text-center">
                ...
                <div className="mt-4 flex items-center justify-center gap-6 flex-wrap">
                  ...
                  <div className="text-center">
                    <p
                      className={`text-2xl font-bold ${(data?.change24h ?? 0) >= 0 ? "text-green-500" : "text-red-500"}`}
                    >
                      {(data?.change24h ?? 0) >= 0 ? "+" : ""}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="glass-card p-5">
                  ...
                  <p
                    className={`text-3xl font-bold font-mono ${(data?.macdHistogram ?? 0) > 0 ? "text-green-500" : "text-red-500"}`}
                  >
                ...
                <div className="glass-card p-5">
                  ...
                  <p
                    className={`text-3xl font-bold font-mono ${(data?.macdLine ?? 0) > 0 ? "text-green-500" : "text-red-500"}`}
                  >
