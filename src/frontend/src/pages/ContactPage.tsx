    ...
    <div className="min-h-screen pt-24 pb-16 bg-gradient-to-b from-white via-gray-50 to-white">
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="metallic-text-secondary text-base font-inter">Direct messaging</p>
                    </div>
                  </a>
                </div>
              </div>
          ...
          <div className="glass-card p-10 text-center animate-fade-in-up animation-delay-600 glow-border">
