        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16 mex-fade-in">
            ...
            <p className="text-xl metallic-text-secondary font-inter max-w-2xl mx-auto leading-relaxed">
              Get in touch with the RBS team. We're here to answer your
              questions and discuss partnership opportunities.
            </p>
          </div>
              ...
              <div className="bg-white border border-gray-200 shadow-sm-gold p-10 glow-border">
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <div>
                      <h3 className="font-poppins font-bold text-gold mb-1 text-xl">
                        Telegram
                      </h3>
                      <p className="metallic-text-secondary text-base font-inter">
                        Join our community
                      </p>
                    </div>
                  </a>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="metallic-text-secondary font-inter leading-relaxed text-lg">
                      ...
                      inquiries, please reach out via Telegram or WhatsApp for
          ...
          <div className="bg-white border border-gray-200 shadow-sm p-10 text-center mex-fade-up glow-border">
            ...
            <p className="metallic-text-secondary font-inter leading-relaxed max-w-3xl mx-auto text-lg">
              For partnership opportunities, institutional inquiries, or media
              requests, please include detailed information in your message. Our
              business development team will review and respond to qualified
              inquiries promptly.
            </p>
          </div>
        </div>
