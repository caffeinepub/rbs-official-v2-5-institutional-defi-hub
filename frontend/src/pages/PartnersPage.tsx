...
import { Handshake, Globe, Code, Users } from 'lucide-react';
          ...
          <div className="max-w-6xl mx-auto space-y-12">
            <div className="text-center space-y-4">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Building the future of decentralized finance together with industry leaders
              </p>
            </div>
            ...
            <div className="space-y-8">
              {partnerCategories.map((category, index) => {
                ...
                return (
                  <SmokySectionTransition key={category.title} delay={100 * (index + 1)}>
            ...
            <SmokySectionTransition delay={400}>
              <Card className="glass-card border-gold/20">
                <CardHeader>
                  ...
                  <CardDescription>What our partners gain from collaboration</CardDescription>
                </CardHeader>
                <CardContent>
