  ...
  return (
    <div className="gman-card rounded-2xl p-6">
      <div className="flex items-center gap-3 mb-5">
        ...
        <div>
          <h3 className="text-lg font-bold text-gold-accent">Contact & Community</h3>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        {CONTACT_LINKS.map((link) => {
          ...
          return (
            ...
            >
              <div className={`w-10 h-10 rounded-xl ${link.iconBg} flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform`}>
                <Icon className={`w-5 h-5 ${link.iconColor}`} />
              </div>
              <div className="min-w-0">
                <p className="text-sm font-semibold text-slate-200 group-hover:text-gold-accent transition-colors">{link.label}</p>
